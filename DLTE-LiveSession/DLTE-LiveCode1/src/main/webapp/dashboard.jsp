...
<%@ page import="org.example.DaoOperation" %>
...
//                ResultSet resultSet = preparedStatement.executeQuery();
        ...
        <table  class="table table-hover table-dark" align="center" border="1" width="40" style="width: 50%">
            <thead>
            <tr><th colspan="5">Loan details</th> </tr>
            <tr>
                <th>Loan Number</th><th>Borrower_name</th>
                <th>Loan Type</th><th>Loan Amnt</th><th>Loan Issued Date</th>
            </tr>
            </thead>
            <tbody>
