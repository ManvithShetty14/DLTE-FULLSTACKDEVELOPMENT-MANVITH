...
//        preparedStatement1.setInt(1,stud.getDoor_no());
//        preparedStatement1.setString(2,stud.getStreet());
//        preparedStatement1.setString(3,stud.getCity());
//        preparedStatement1.setInt(4,stud.getPincode());
//
