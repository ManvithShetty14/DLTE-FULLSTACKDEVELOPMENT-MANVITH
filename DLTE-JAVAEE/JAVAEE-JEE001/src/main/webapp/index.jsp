...
<%--            <img class="col-2" src="files/SavinCardIco.png" width="300px" height="100px" />--%>
            <p class="col-7 display-6 align-self-center text-center text-info mt-3">Customer can login here!!!!!!</p>
        </div>
    </div>
...
<%--        </div>--%>
        ...
        <div class="col-lg-3 col-sm-12 align-self-center">
            ...
            <div class="row justify-content-center p-1">
                <h3 class="text-center text-light bg-info rounded-5">Customer Login</h3>
...
<%--                <h3 class="text-center text-light bg-info rounded-5">Banker Portal</h3>--%>
                <form action="authenticate" method="post" name="log" class="rounded-1 shadow-lg p-1 text-info">
                    <div class="form group">
                        ...
                        <input type="text" placeholder="Customer ID" name="customerId" class="form-control"/>
                    </div>
                    <div class="form group">
                        <label>
                            Customer Password
                        ...
                        <input type="password" placeholder="Customer Password" name="customerPass" class="form-control"/>
                    </div>
                    <div class="row mt-2 justify-content-around">
                        <input type="submit" class="col-3 btn btn-outline-danger" value="Login"/>
                        <input type="reset" class="col-3 btn btn-outline-danger" value="Cancel"/>
                    </div>
                </form>
            </div>
            <!-- </div> -->
